const eventTracks = [
    { id: 'kills', label: 'Kills', color: '#f87171', count: 156 },
    { id: 'deaths', label: 'Deaths', color: '#c084fc', count: 203 },
    { id: 'loot', label: 'Loot', color: '#facc15', count: 512 },
    { id: 'storm', label: 'Storm Deaths', color: '#34d399', count: 87 },
  ]
      ...
      <div className="h-64 border-t border-white/10 flex-shrink-0 flex flex-col bg-[#0f1117]">
        ...
        <div className="flex items-center gap-4 px-5 py-3 border-b border-white/10">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="text-white/40 hover:text-white/80 transition-colors text-sm font-bold px-1">&lt;&lt;</button>
            <button className="w-8 h-8 rounded-lg bg-purple-600 hover:bg-purple-500 flex items-center justify-center transition-colors">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col relative">
            ...
            <div className="flex-1 flex flex-col relative">
              ...
              {/* Playhead */}
              <div className="absolute top-0 bottom-0 w-px bg-purple-500 opacity-80" style={{ left: '37%' }}>
